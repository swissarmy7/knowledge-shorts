...
visual_desc = "South Park cutout cartoon style. A delicious plate of sweet and sour pork, with colorful cartoon labels floating around it: 탕(달고) + 수(시고) + 육(돼지) connecting to make 탕수육.."
...
output_path = Path("/var/www/html/my_shorts/output/cache/images/agy/af667d8a99e37616c6db5428528962a3.png")
